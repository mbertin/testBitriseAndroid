...
New projects should follow the Android Gradle project structure that is defined on the [Android Gradle plugin user guide](http://tools.android.com/tech-docs/new-build-system/user-guide#TOC-Project-Structure). Please refer to the __Betclic Android Boilerplate__ available on TFS

TODO Put url of project boilerplate
...
```java
Picasso.with(context).load("https://betclick.fr/img/betclic-logo.png").into(imageView);
```

```java
Picasso.with(context)
        .load("https://betclick.fr/img/betclic-logo.png")
        .into(imageView);
```
...
```java
loadPicture(context, "https://betclick.fr/img/betclic-logo.png", mImageViewProfilePicture, clickListener, "Title of the picture");
```

```java
loadPicture(context,
        "https://betclick.fr/img/betclic-logo.png",
...
```
Copyright 2017 Betclic Everest Group.

Written by Mathieu Bertin 03/03/2017
```
